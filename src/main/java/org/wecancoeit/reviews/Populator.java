...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Restaurant restaurants2 = new Restaurant("Red Lobster", seafood, "", "https://www.redlobster.com/","img/redLobster.png",hashtag4,hashtag2, hashtag3);
        ...
        Restaurant restaurants4 = new Restaurant("Hoyo's Kitchen", Africanfood, "", "http://hoyoskitchen.com/","img/Somali Restaurant.jpg",hashtag5,hashtag);
        Restaurant restaurants5 = new Restaurant("Lan Viet", Asian, "", "https://lanvietmarket.com/","img/lanviet.jpg/",hashtag5, hashtag2);
        Restaurant restaurants6 = new Restaurant("Gogi Korean BBQ", Asian, "", "https://gogikbbq.com/","img/Gogi.png/",hashtag1,hashtag3);
        Restaurant restaurants7 = new Restaurant("Local Cantina", Mexican, "", "https://localcantina.com/","img/local-cantina-logo.png/",hashtag1,hashtag);
        Restaurant restaurants8 = new Restaurant("El Vaquero", Mexican, "", "https://www.mexicanrestauranthilliard.com/","img/elVaquero.jpg/");
